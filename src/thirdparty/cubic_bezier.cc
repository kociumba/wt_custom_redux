...
// credit: https://github.com/chromium/chromium/blob/main/ui/gfx/geometry/cubic_bezier.cc
...
double CubicBezier::Solve(double x) const { return SolveWithEpsilon(x, kBezierEpsilon); }
...
double CubicBezier::Slope(double x) const { return SlopeWithEpsilon(x, kBezierEpsilon); }
